...
<div class="container text-center">
    <div class="row my-md-3 ">
      <div class="col d-flex justify-content-center ">
        ...
        <h1 class="text-warning fst-italic fs-1">salut {{ $user->prenom }}  </h1>
      ...
      <div class="col-md-8 account">
        <div class="card d-flex flex-row"> 
            ...
            <div class="col-md-4 d-flex align-items-center justify-content-center">
                @if ($user->image) 
                <img src="/images/{{$user->image}}" class="card-img-top rounded-circle img-fluid m-md-3" alt="photoUser" style="width: 15rem;">
                @else 
                <img  src="/images/default_user.jpg" class="card-img-top rounded-circle img-fluid m-md-3" alt="photoDefault" style="width: 15rem;">
                @endif
            </div>
